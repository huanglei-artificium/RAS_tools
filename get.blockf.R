...
option_list <- list(
    ...
    make_option(c("--popLeftFillna"), type = "character", default = NA),
    make_option(c("--popRight1"), type = "character"),
    make_option(c("--popRight2"), type = "character", default = NA),
    make_option(c("--popRightFillna"), type = "character", default = NA),
...
pop_left_fillna <- opt$popLeftFillna

pop_right1_str <- opt$popRight1

pop_right2_str <- opt$popRight2

pop_right_fillna <- opt$popRightFillna
